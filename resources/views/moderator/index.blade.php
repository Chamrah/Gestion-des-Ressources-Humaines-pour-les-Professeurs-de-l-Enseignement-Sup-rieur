...
<section class="home-section">
    <div class="home-content">
        ...
        <span class="text">Moderateur</span>
    </div>
    <div class="mycontent">
                        ...
                        <tr data-toggle="modal" data-target="#adminModal" data-id="{{ $admin->id }}">
                            ...
                            <td>
                                <div class="btn-group" role="group" aria-label="Admin Actions">
                                    ...
                                    <form action="{{ route('admin.delete', $admin->id) }}" method="POST" onsubmit="return confirm('Êtes-vous sûr de vouloir supprimer cet administrateur ?');">
                                        @csrf
                                        @method('DELETE')
                    ...
                    <form action="{{ route('addAdmin') }}" method="post">
                        ...
                        <div class="modal-content">
                            <div class="modal-header">
                                <h1 class="modal-title fs-5" id="exampleModalLabel">Titre de modele</h1>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="mb-3">
                                    <label for="formGroupExampleInput3" class="form-label">Mot de passe</label>
